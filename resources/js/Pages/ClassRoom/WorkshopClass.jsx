...
import { BookOpen, Calendar, Clock, Tag, Trophy, School } from "lucide-react";
...
function WorkshopClass() {
    ...
    useEffect(() => {
        if (user) {
            ...
            setData("level", "workshop");
            setData("total_meet", 1);
            setData("image", "");
            setData("students", "");
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <InputSelection
                                ...
                                onChange={handleChange}
                                options={[
                                    100000, 125000, 150000, 200000, 250000,
                                ]}
                                color="green"
                            />
