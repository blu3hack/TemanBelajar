                    ...
                    <div className="space-y-6 pb-6">
                        ...
                        <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 rounded-3xl p-6 lg:p-8 text-white shadow-lg">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <button className="w-12 h-12 lg:w-14 lg:h-14 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all">
                                    <Bell size={20} />
                                </button>
                            </div>
